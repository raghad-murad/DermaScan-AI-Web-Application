...
const steps = [
  ...
  { icon: FileCheck, title: 'Review & Confirm', desc: 'Review the AI predictions with confidence scores, confirm or modify the diagnosis, and generate reports.' },
];
...
const faqs = [
  ...
  { q: 'How do I generate a diagnostic report?', a: 'After completing an analysis and confirming the diagnosis, you can generate a PDF diagnostic report or prescription directly from the results page.' },
  ...
  return (
    <div>
      ...
      <div className="p-6 max-w-3xl space-y-8">
        <div>
          <h2 className="text-2xl font-heading font-medium mb-2">How to Use DermAI Pro</h2>
